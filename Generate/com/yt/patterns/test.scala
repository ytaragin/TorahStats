...
object test {
  ...
  def main(args: Array[String]): Unit = {
    ...
    def t =
      "וַיֹּ֣אמֶר יְהוָ֔ה וַיֹּ֣אמֶר יְהוָ֔ה זַעֲקַ֛ת סְדֹ֥ם וַעֲמֹרָ֖ה כִּי-רָ֑בָּה וְחַ֨טָּאתָ֔ם כִּ֥י כָבְדָ֖ה מְאֹֽד:"
    def t1 =
      " וְאֶת-הֲדוֹרָ֥ם וְאֶת-אוּזָ֖ל וְאֶת-דִּ וְאֶת-הֲדוֹרָ֥ם וְאֶת-אוּזָ֖ל וְאֶת-דִּ"
    ...
    var files = new java.io.File("data").listFiles;
